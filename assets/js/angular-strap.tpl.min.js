...
! function (t, e, n) {
    ...
    angular.module('mgcrea.ngStrap.alert').run(['$templateCache', function (t) {
        ...
        t.put('typeahead/typeahead.tpl.html', '<ul tabindex="-1" class="typeahead dropdown-menu typahdsug" ng-show="$isVisible()" role="select"><li role="presentation" ng-repeat="match in $matches" ng-class="{active: $index == $activeIndex}"><a role="menuitem" tabindex="-1" ng-click="$select($index, $event)" ng-bind="match.label"></a></li></ul>')
    }])
}(window, document);
